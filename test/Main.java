...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(" El Precio final es : " + gastronomia.calcularPrecioFinal(LocalDate.of(2020, 10, 28))+ " pesos");
            System.out.println("---------------------------------------");

            // 2-2 Calcular e imprimir precio final Hospedaje
            System.out.println("2-2");
            Servicio hospedaje = sistema.traerServicio("287282");
            System.out.println(" El Precio final es : " + hospedaje.calcularPrecioFinal(LocalDate.of(2020, 10, 27))+ " pesos");
            System.out.println("---------------------------------------");
